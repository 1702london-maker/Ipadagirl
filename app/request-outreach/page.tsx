        ...
        <section className="py-20 bg-pink-soft/30">
          <div className="max-w-container-max mx-auto px-4 md:px-6">
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">
              Schools, community leaders and organisations can apply for an iPadAGirl outreach. Submitting this form does not automatically guarantee a visit â€” our team will review each application and be in touch.
            </p>
          </div>
        </section>
              ...
              <form className="space-y-6 bg-base-white p-8 rounded-3xl border border-surface-container-high shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="e.g. JSS1â€“SSS3" className="w-full px-4 py-3 rounded-lg border border-outline-variant focus:outline-none focus:border-coral-warm transition-colors" />
                  </div>
                </div>
                <div>
