    ...
    <>
      ...
      <main>
        ...
        <section className="py-20 bg-base-white">
          <div className="max-w-container-max mx-auto px-6">
            <div className="mb-10">
              <h2 className="font-headline-sm text-headline-sm text-ink-navy mb-2">JOAK Secondary School Outreach — July 2026</h2>
              <p className="text-on-surface-variant font-body-md">Okun-Idado, Ibeju-Lekki, Lagos State · 80 girls reached</p>
            </div>
